			...
			this.defaults = {
				feeds: {
					facebook: {
						...
						url: '<t4 type="media" id="4803" formatter="path/*"/>',
						feed: 'feed', // feed, posts
						icon: '<t4 type="media" id="1662" formatter="path/*"/>'
					},
					twitter: {
						id: '',
						intro: 'Tweeted',
						...
						url: '<t4 type="media" id="1673" formatter="path/*"/>',
						icon: '<t4 type="media" id="1670" formatter="path/*"/>'
					},
					google: {
						id: '',
						intro: 'Shared',
						...
						image_width: 300,
						shares: true,
						icon: '<t4 type="media" id="1664" formatter="path/*"/>'
					},
					youtube: {
						id: '',
						intro: 'Uploaded',
						...
						icon: '<t4 type="media" id="1672" formatter="path/*"/>'
					},
					flickr: {
						id: '',
						intro: 'Uploaded',
						out: 'intro,thumb,title,text,share',
						lang: 'en-us',
						icon: '<t4 type="media" id="1663" formatter="path/*"/>'
					},
					delicious: {
						id: '',
						intro: 'Bookmarked',
						out: 'intro,thumb,title,text,user,share',
						icon: '<t4 type="media" id="1659" formatter="path/*"/>'
					},
					rss: {
						id: '',
						intro: 'Posted',
						out: 'intro,thumb,title,text,user,share',
						url: '<t4 type="media" id="4804" formatter="path/*"/>',
						text: 'contentSnippet',
						icon: '<t4 type="media" id="4802" formatter="path/*"/>'
					},
					lastfm: {
						id: '',
					...
					dribbble: {
						...
						feed: 'shots,likes',
						icon: '<t4 type="media" id="1661" formatter="path/*"/>'
					},
					vimeo: {
						id: '',
						...
						thumb: 'large',
						stats: true,
						icon: '<t4 type="media" id="1671" formatter="path/*"/>'
					},
					stumbleupon: {
						id: '',
						...
						icon: '<t4 type="media" id="1668" formatter="path/*"/>'
					},
					deviantart: {
						id: '',
						intro: 'Deviation',
						out: 'intro,thumb,title,text,user,share',
						icon: '<t4 type="media" id="1660" formatter="path/*"/>'
					},
					tumblr: {
						id: '',
						intro: 'Posted',
						...
						thumb: 100,
						video: 250,
						icon: '<t4 type="media" id="1669" formatter="path/*"/>'
					},
					instagram: {
						id: '',
					    intro: 'Posted',
						...
						icon: '<t4 type="media" id="1665" formatter="path/*"/>'
					}
				},
				remove: '',
				twitterId: '',
